...
?>
            <header id="minorHeader">
               <h2>Welcome to RoarConnect's Food Delivery Marketplace</h2>
...
?>
               ...
               <div <?php echo currentUserIsLoggedInAsAdmin() ? 'class="panel panel-primary" ' : '' ?>id="displayAsInlineBlock">
                  <a href="choose_category_of_food.php?i=<?php echo $rowContainingVendorData['vendor_id'] ?>" id="looksLikeALargeHoverableIcon">
                     <div id="iconImage" style="background-image: url( '<?php echo 'assets/images/vendorFliers/' . $rowContainingVendorData['vendor_name'] . '.jpg' ?>' ); background-size: cover;"></div>
...
?>
                  <div>
                     <a href="add_or_edit_vendor.php?requiredAction=editVendor&i=<?php echo $rowContainingVendorData['vendor_id'] ?>" class="btn btn-primary btn-sm">Edit Vendor</a>
                     <a href="delete_vendor.php?i=<?php echo $rowContainingVendorData['vendor_id'] ?>" class="btn btn-primary btn-sm">Delete Vendor</a>
                  </div>
<?php
      }
?>
