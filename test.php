...
$result = mysqli_query($db, $query) or die('<p style="color: red; font-family: serif;">Unable to query database.</p>'.$query);
...
mysqli_query($db, $query) or die('<p style="color: red; font-family: serif;">Unable to query database.</p>'.$query);
echo '<br/>Done';
?>